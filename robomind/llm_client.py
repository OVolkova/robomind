...
SYSTEM_PROMPT = f"""You are the brain of a Petoi Bittle robot dog. You are friendly, playful, and physically aware.
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                "action": {
                    "type": "string",
                    "enum": list(PETOI_COMMANDS.keys()),
                    "description": "Petoi skill key to execute on the robot",
                }
            },
            "required": ["action"],
        },
